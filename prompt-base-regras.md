...
* **Interesse do cliente** (ex.. "quer um pc pra rodar Warzone", quer um notebook pra faculdade e jogar", "quer só um mouse bom")
...
### 4)Regras de ouro (comportamento - guard rails)
...
### 5)Gatilhos de oportunidade e interesse (use automaticamente)
